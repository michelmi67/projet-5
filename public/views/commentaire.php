                ...
                foreach($commentaires_signales as $commentaire_signale):
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class ="supression" href = "?action=suprime_comment&id=<?php echo $commentaire_signale['id']; ?>"><i class="fas fa-times"></i></a>
                        </td>
            ...
            <tbody>
                ...
                foreach($commentaires as $commentaire):
                    ...
                    <tr>
                        ...
                        <a class ="supression" href = "?action=suprime_comment&id=<?php echo $commentaire['id']; ?>"><i class="fas fa-times"></i></a>
                    </td>
