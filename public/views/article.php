        ...
        foreach($commentaires as $commentaire):
            ...
            <div class="commentaire" id = "commentaire_<?php echo $commentaire['id']; ?>">
                ...
                <p><?php echo htmlspecialchars($commentaire['message']); ?></p>
                    ...
                    if($_SESSION['rang'] === '3'):
                        ?>
                        <a class = "signaler" href = "?action=signal_comment&id=<?php echo $commentaire['id']; ?>"><i class="fas fa-exclamation-triangle"></i>signaler</a>
                        <?php
                    endif; 
                    ?>
                    <?php
                    ...
                    if($_SESSION['pseudo'] === $commentaire['auteur'] OR $_SESSION['rang'] === '1' OR $_SESSION['rang'] === '2'):
                        ?>
                        <a class ="supression" class ="supression" href = "?action=suprime_comment&id=<?php echo $commentaire['id']; ?>"><i class="fas fa-times"></i>supprimer</a>
                        <?php
                    endif;
                    ?>
            </div>
